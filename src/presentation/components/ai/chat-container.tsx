...
export const ChatContainer: React.FC<ChatContainerProps> = ({
  ...
  return (<div className="flex flex-col h-full max-h-full bg-sapphire-900 border border-emerald-400/20 rounded-lg overflow-hidden">
      {showProviderSelector && (    <div className="bg-sapphire-800/80 backdrop-blur-sm border-b border-emerald-400/20 p-2">    <ProviderSelector
        ...
        {messages.length === 0 ? (    <div className="flex items-center justify-center h-full text-emerald-400/70 p-4">    <div className="text-center">    <div className="w-16 h-16 mx-auto mb-4 rounded-full border-2 border-dashed border-emerald-400/30 flex items-center justify-center text-emerald-400/40">    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>
                </svg>
