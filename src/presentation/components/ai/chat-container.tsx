...
export const ChatContainer: React.FC<ChatContainerProps> = ({
  ...
  return (
    <div className="flex flex-col h-full max-h-full bg-sapphire-900 border border-emerald-400/20 rounded-lg overflow-hidden">
      {showProviderSelector && (
        <div className="bg-sapphire-800/80 backdrop-blur-sm border-b border-emerald-400/20 p-2">
          <ProviderSelector
            providers={providers}
      ...
      <div className="flex-1 overflow-y-auto">
        {messages.length === 0 ? (
          <div className="flex items-center justify-center h-full text-emerald-400/70 p-4">
            <div className="text-center">
              ...
              <h3 className="text-lg font-cyber mb-2 text-emerald-400">BlockSwarms Token AI</h3>
