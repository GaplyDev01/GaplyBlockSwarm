...
export default function HomePage() {
  ...
  return (    <div className="min-h-screen bg-background text-foreground">    
        ...
        <Link href="/" className="text-foreground hover:text-primary">Home</Link>    <Link href="/dashboard" className="text-foreground hover:text-primary">Dashboard</Link>    <Link href="/login" className="text-foreground hover:text-primary">Login</Link>    <Link 
              href="/signup" 
