          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div>
                ...
                <div className="bg-sapphire-800/30 border border-emerald-400/20 rounded-lg p-6">
              ...
              <div>
                <h2 className="text-xl font-cyber mb-4">V2 Features</h2>
                <div className="bg-sapphire-800/30 border border-emerald-400/20 rounded-lg p-6">
                  <ul className="list-disc list-inside space-y-2 text-emerald-400/80">
                    <li>Enhanced transaction parsing</li>
                    <li>Improved token metadata handling</li>
                    <li>Smart caching system for better performance</li>
                    <li>Detailed swap transaction information</li>
                    <li>Better error handling and fallbacks</li>
                    <li>Support for Associated Token Accounts</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div>
                <h2 className="text-xl font-cyber mb-4">Standard Transactions</h2>
                <WalletTransactions maxItems={5} />
              </div>
              
              <div>
                <h2 className="text-xl font-cyber mb-4">Enhanced V2 Transactions</h2>
                <WalletTransactionsV2 maxItems={5} />
              </div>
            </div>
            
            <div className="text-center mt-12 text-emerald-400/50 text-sm">
              <p>BlockSwarms Solana V2 Implementation Demo</p>
              <p className="mt-1">Note: This demo automatically enables the V2 implementation via client-side settings</p>
            </div>
          </div>
        </div>
      </WalletContextProvider>
        ...
        <div className="max-w-7xl mx-auto mb-6">
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              ...
              <h1 className="text-2xl font-cyber text-emerald-400 text-shadow-neon flex items-center">
                Solana AI Analysis
                <Button 
                  variant="ghost" 
                  size="sm"
          ...
          <div className="lg:col-span-1">
            <Tabs defaultValue="info" className="w-full">
              <TabsList className="w-full mb-4 bg-sapphire-800/50 border border-emerald-400/20">
                ...
                <TabsTrigger value="news" className="flex-1 data-[state=active]:text-emerald-400">
                  News
                </TabsTrigger>
              </TabsList>
                ...
                <Card className="mt-4">
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="font-mono">$259.96</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-mono text-green-400">+15.2%</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">90-Day Change</span>
                      <span className="font-mono text-green-400">+82.7%</span>
                    </div>
                    <div className="flex justify-between">
                  ...
                  <CardContent className="pt-4">
                    <div className="space-y-4">
                      <div className="glass-card p-3 rounded-md hover:neon-border transition-all cursor-pointer">
                        <h3 className="font-cyber text-base mb-1">Solana TVL Reaches New High</h3>
                      ...
                      <div className="glass-card p-3 rounded-md hover:neon-border transition-all cursor-pointer">
                        <h3 className="font-cyber text-base mb-1">Jupiter Breaks Volume Records</h3>
                        <p className="text-sm text-muted-foreground mb-2">
                      ...
                      <div className="glass-card p-3 rounded-md hover:neon-border transition-all cursor-pointer">
                        <h3 className="font-cyber text-base mb-1">Solana Mobile Announces New SDK</h3>
                        <p className="text-sm text-muted-foreground mb-2">
          ...
          <div className="lg:col-span-2 h-[calc(100vh-8rem)]">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full flex flex-col">
              <TabsList className="w-full mb-4 bg-sapphire-800/50 border border-emerald-400/20">
                ...
                <TabsTrigger value="analysis" className="flex-1 data-[state=active]:text-emerald-400">
                  <BarChart2 size={16} className="mr-2" />
                  Technical Analysis
                </TabsTrigger>
              </TabsList>
              
              <TabsContent value="chat" className="h-full mt-0 flex-1 flex flex-col">
                <ChatContainer
                  messages={messages}
                ...
                <Card variant="glass" className="h-full flex flex-col">
                  ...
                  <CardContent className="flex-1 p-6">
                    <div className="flex flex-col items-center justify-center h-full text-center space-y-6">
                      ...
                      <h3 className="text-xl font-cyber text-shadow-neon">Coming Soon</h3>
                      <p className="text-muted-foreground max-w-md">
                        Advanced technical analysis with indicators, trend lines, and AI-powered insights is coming in the next update.
                      </p>
                      <Button onClick={() => setActiveTab('chat')}>Return to Chat</Button>
                    </div>
                  </CardContent>
                </Card>
              </TabsContent>
