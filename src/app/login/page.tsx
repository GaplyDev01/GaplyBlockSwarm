...
export default function LoginPage() {
  return (    <div className="min-h-screen bg-sapphire-900 overflow-hidden bg-tech-pattern">
        ...
        <h1 className="text-3xl font-cyber font-bold text-emerald-400">Login to BlockSwarms</h1>    <p className="text-emerald-400/70 mt-2">
              Access your AI-powered Solana trading dashboard
            </p>
          </div>    <div className="bg-sapphire-800/50 backdrop-blur-sm border border-emerald-400/20 rounded-lg p-4 shadow-xl">    
        <SignIn 
              appearance={{
                elements: {
