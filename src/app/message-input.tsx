...
export const MessageInput: React.FC<MessageInputProps> = ({
  ...
  return (
    <form onSubmit={handleSubmit} className="border-t border-emerald-400/20 p-4 bg-sapphire-800/80 backdrop-blur-sm">
      <div className="flex items-end space-x-2 max-w-screen-lg mx-auto">
        ...
        >
          {isProcessing ? (
            <span className="inline-block h-4 w-4 rounded-full border-2 border-sapphire-900 border-t-transparent animate-spin"></span>
          ) : (
