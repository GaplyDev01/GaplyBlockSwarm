      ...
      <div className="relative bg-sapphire-800 border border-emerald-400/30 rounded-lg shadow-xl max-w-md w-full p-6 mx-4">
        ...
        {submitted ? (
          <div className="text-center py-8">
            ...
            <h3 className="text-2xl font-cyber text-emerald-400 mb-2">Welcome to the Swarm!</h3>
          ...
          <>
            <h3 className="text-2xl font-cyber text-emerald-400 mb-2">Join the Swarm</h3>
            <p className="text-emerald-400/70 mb-6">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <p className="text-xs text-emerald-400/50 mt-4 text-center">
