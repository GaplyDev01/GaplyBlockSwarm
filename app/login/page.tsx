      ...
      <div className="relative flex flex-col items-center justify-center min-h-screen p-6">
        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-cyber font-bold text-emerald-400">Connect Your Wallet</h1>
          ...
          <div className="bg-sapphire-800/50 backdrop-blur-sm border border-emerald-400/20 rounded-lg p-8 shadow-xl">
            ...
            {loginStatus === 'success' ? (
              <div className="text-center py-6">
                ...
                <h3 className="text-xl font-bold text-emerald-400 mb-2">Wallet Connected!</h3>
                ...
                <p className="text-emerald-400/70 text-sm animate-pulse">
              ...
              <div className="space-y-6">
                <div className="bg-sapphire-900/50 p-4 rounded-lg border border-emerald-400/10">
                  ...
                  {loginStatus === 'error' && errorMessage && (
                    <div className="mt-3 text-red-400 text-sm bg-red-400/10 p-2 rounded border border-red-400/20">
                      {errorMessage}
                    </div>
                  )}
                </div>
                
                <div className="border-t border-emerald-400/10 pt-4">
                  <p className="text-xs text-emerald-400/50 mb-2">Don't have a Solana wallet?</p>
                  <a 
