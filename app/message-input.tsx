...
export const MessageInput: React.FC<MessageInputProps> = ({
  ...
  return (<form onSubmit={handleSubmit} className="border-t border-emerald-400/20 p-4 bg-sapphire-800/80 backdrop-blur-sm">    <div className="flex items-end space-x-2 max-w-screen-lg mx-auto">    <div className="flex-1 min-h-[40px] rounded-lg border border-emerald-400/30 overflow-hidden focus-within:ring-2 focus-within:ring-emerald-400/50 transition-shadow bg-sapphire-900/50">    <textarea
            ref={textareaRef}
            value={message}
        ...
        >
          ...
          ) : (    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">    <line x1="22" y1="2" x2="11" y2="13"></line>    <polygon points="22 2 15 22 11 13 2 9 22 2"></polygon>
            </svg>
          )}
        </button>
      </div>
