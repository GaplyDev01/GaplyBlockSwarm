...
export default function ErrorPage({
  ...
  return (
    <div className="min-h-screen bg-sapphire-900 text-emerald-400 flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full bg-sapphire-800/50 backdrop-blur-sm border border-emerald-400/20 rounded-lg p-8 shadow-xl">
        <h2 className="text-3xl font-cyber text-center mb-6">Application Error</h2>
        
        <div className="rounded-md bg-red-900/20 border border-red-500/30 p-4 mb-6">
          <p className="text-red-400/80">
            {error?.message || 'An unexpected error occurred'}
          </p>
          {error?.digest && (
            <p className="text-xs mt-2 text-red-400/60">Error ID: {error.digest}</p>
          )}
        </div>
        
        <div className="mb-6 text-emerald-400/70">
          <p className="mb-2">
          ...
          <ul className="list-disc list-inside text-sm space-y-1">
            ...
            <li>Try the demo mode for a limited experience</li>
