      ...
      {!isUser && (
        <div className="flex-shrink-0 mr-3">
          <div className={cn(
            ...
            {avatar ? (
              <img src={avatar} alt={role} className="w-full h-full rounded-full" />
            ) : (
        ...
        <div className={cn(
          ...
          {isLoading || isLoadingRole ? (
            <div className="flex items-center space-x-2">
              ...
              <div className="h-2 w-2 bg-muted-foreground rounded-full animate-pulse [animation-delay:200ms]"></div>
              <div className="h-2 w-2 bg-muted-foreground rounded-full animate-pulse [animation-delay:400ms]"></div>
            </div>
          ) : (
