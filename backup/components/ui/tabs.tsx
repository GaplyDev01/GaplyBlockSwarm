...
>(({ className, ...props }, ref) => (    <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:bg-background/50 data-[state=active]:border-b-2 data-[state=active]:border-emerald-400",
      "data-[state=active]:text-shadow-neon hover:text-emerald-400/90",
